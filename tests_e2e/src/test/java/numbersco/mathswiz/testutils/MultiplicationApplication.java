package numbersco.mathswiz.testutils;

import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.JavaType;
import com.fasterxml.jackson.databind.ObjectMapper;
import numbersco.mathswiz.testutils.beans.AttemptResponse;
import numbersco.mathswiz.testutils.beans.User;
import numbersco.mathswiz.testutils.beans.LeaderBoardPosition;
import numbersco.mathswiz.testutils.beans.Stats;
import numbersco.mathswiz.testutils.beans.ScoreResponse;
import numbersco.mathswiz.testutils.http.ApplicationHttpUtils;
...
public class MultiplicationApplication {
  ...
  public AttemptResponse sendAttempt(String userAlias, int factorA, int factorB, int result) {
    String attemptJson = "{\"user\":{\"alias\":\"" + userAlias + "\"}," + "\"multiplication\":{\"factorA\":\"" + factorA
